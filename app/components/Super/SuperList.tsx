  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      {!shoppingList ? (
        <button
          type="button"
          className="bg-red-300 font-bold rounded-md p-5 flex flex-row text-white m-auto justify-center items-center "
        >
          <svg
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {shoppingList
                    ...
                    .toFixed(2)}
                </div>):(<label className="text-sm text-black">No hay productos en la lista</label>)}
              </div>
                  ...
                  <li key={category}>
                    <div className="flex justify-between items-center">
                      <div
                        ...
                        style={{ userSelect: "none" }}
                      >
                        <h3 className="font-bold category-header ">
                          {category}
                        </h3>{" "}
